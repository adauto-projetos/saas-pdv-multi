...
const STORES: Store[] = [
  {
    ...
    catalog: [
      { name: "Arroz Branco 5kg", unit: "un", cost: 2200, markup: 30, stock: 40, barcode: "7891000000101", category: "Mercearia" },
      { name: "Feijão Carioca 1kg", unit: "un", cost: 750, markup: 35, stock: 60, barcode: "7891000000102", category: "Mercearia" },
      { name: "Açúcar Refinado 1kg", unit: "un", cost: 420, markup: 30, stock: 50, barcode: "7891000000103", category: "Mercearia" },
      { name: "Café Torrado 500g", unit: "un", cost: 1500, markup: 40, stock: 30, barcode: "7891000000104", category: "Mercearia" },
      { name: "Óleo de Soja 900ml", unit: "un", cost: 690, markup: 25, stock: 45, barcode: "7891000000105", category: "Mercearia" },
      { name: "Leite Integral 1L", unit: "un", cost: 520, markup: 28, stock: 80, barcode: "7891000000106", category: "Mercearia" },
      ...
      { name: "Sabão em Pó 1kg", unit: "un", cost: 1290, markup: 30, stock: 25, barcode: "7891000000107", category: "Limpeza" },
    ],
  },
  {
    email: "bar@teste.com",
    ...
    catalog: [
      { name: "Cerveja Lata 350ml", unit: "un", cost: 290, markup: 55, stock: 120, barcode: "7892000000201", category: "Bebidas" },
      { name: "Cerveja Long Neck 355ml", unit: "un", cost: 450, markup: 60, stock: 80, barcode: "7892000000202", category: "Bebidas" },
      { name: "Refrigerante Lata 350ml", unit: "un", cost: 250, markup: 50, stock: 100, barcode: "7892000000203", category: "Bebidas" },
      { name: "Água Mineral 500ml", unit: "un", cost: 120, markup: 80, stock: 150, barcode: "7892000000204", category: "Bebidas" },
      { name: "Energético 250ml", unit: "un", cost: 590, markup: 50, stock: 60, barcode: "7892000000205", category: "Bebidas" },
      { name: "Gelo 2kg", unit: "un", cost: 600, markup: 50, stock: 30, barcode: "7892000000206", category: "Bebidas" },
      ...
      { name: "Amendoim 100g", unit: "un", cost: 180, markup: 90, stock: 40, barcode: "7892000000207", category: "Lanches" },
      { name: "Porção de Batata", unit: "un", cost: 800, markup: 75, stock: 0, category: "Lanches" },
    ],
  },
  {
    ...
    catalog: [
      ...
      { name: "Refrigerante Lata 350ml", unit: "un", cost: 250, markup: 50, stock: 60, barcode: "7893000000301", category: "Bebidas" },
    ],
  },
];
...
async function seedStore(store: Store) {
  ...
  // 3) Categorias padrão (RN03, 0025F) — idempotente: no-op se a loja já
  // foi seedada antes (reuso do mesmo tenant entre execuções deste script).
  ...
  // 4) Produtos (idempotente: limpa e reinsere)
